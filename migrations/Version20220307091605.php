 ...
 */
final class Version20220307091605 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prestation ADD subtitle_option VARCHAR(255) DEFAULT NULL, ADD description_option LONGTEXT DEFAULT NULL');
    }
