 ...
 */
final class Version20220307143736 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prestation ADD upadted_at DATETIME DEFAULT NULL');
    }
