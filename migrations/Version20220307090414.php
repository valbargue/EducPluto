 ...
 */
final class Version20220307090414 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prestation ADD subtitle VARCHAR(255) NOT NULL');
    }
